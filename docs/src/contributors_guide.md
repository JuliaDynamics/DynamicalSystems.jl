...
3. Contribute code by solving existing issues in the subpackages composing **DynamicalSystems.jl**. The easiest issues to tackle are labelled "good first issue".
